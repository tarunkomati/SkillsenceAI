      ...
      <div className="container-custom section-padding relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold gradient-text">SkillSense AI</span>
            </Link>
            <p className="text-muted-foreground text-sm mb-6 max-w-xs">
              AI-powered skill discovery and verification platform for students, recruiters, and universities.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            (c) 2025 SkillSense AI. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm">
